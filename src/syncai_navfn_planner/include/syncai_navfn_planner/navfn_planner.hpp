#ifndef SYNCAI_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
#define SYNCAI_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
...
class NavfnPlanner : public syncai_nav_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
  ...
  void configure(
    rclcpp::Node::SharedPtr & node, std::string name, std::shared_ptr<tf2_ros::Buffer> tf,
