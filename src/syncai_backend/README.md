...
datagram went out. It is decoded to labels *and* passed through raw, because MPC's
reported code is unknown and `"UNKNOWN"` beside a raw integer is the only thing
that lets an operator find out what it is.
