...
The robot's host-level plumbing: one rclpy node, `syncai_sys_manager`, that
...
Started in the byobu sessions' `sys_manager` window, next to the
`driver_manager` window.
