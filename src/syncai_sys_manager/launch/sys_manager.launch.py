# Launch the syncai_sys_manager node — hosts the WiFi management services
...
logger = launch_logging.get_logger("sys_manager.launch")
...
def launch_setup(context, *args, **kwargs):
    ...
    sys_manager_node = Node(
        package="syncai_sys_manager",
        executable="sys_manager_node",
        namespace=robot_id,
        output="screen",
        parameters=[{"robot_id": robot_id}],
    )

    return [sys_manager_node]
