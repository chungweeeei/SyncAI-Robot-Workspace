...
syncai_costmap_2d::Costmap2D * NodeHybrid::sampled_costmap = nullptr;
...
void NodeHybrid::getNeighbors(
  std::function<bool(const unsigned int &, syncai_planner::NodeHybrid * &)> & NeighborGetter,
  GridCollisionChecker * collision_checker,
  const bool & traverse_unknown,
