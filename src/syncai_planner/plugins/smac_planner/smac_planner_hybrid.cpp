...
#include "Eigen/Core"
#include "syncai_planner/plugins/smac_planner/smac_planner_hybrid.hpp"
...
PLUGINLIB_EXPORT_CLASS(syncai_planner::SmacPlannerHybrid, syncai_nav_core::GlobalPlanner)
