...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
...
/**
 * @class syncai_planner::CostmapDownsampler
...
public:
   ...
   * @param node Node pointer (may be empty to suppress publishing)
   ...
   */
  syncai_costmap_2d::Costmap2D * downsample(const unsigned int & downsampling_factor);
...
protected:
  ...
  std::unique_ptr<syncai_costmap_2d::Costmap2D> _downsampled_costmap;
  std::unique_ptr<syncai_costmap_2d::Costmap2DPublisher> _downsampled_costmap_pub;
};

}  // namespace syncai_planner

#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
