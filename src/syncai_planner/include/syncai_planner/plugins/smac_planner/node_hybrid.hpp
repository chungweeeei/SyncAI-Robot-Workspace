...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_HYBRID_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_HYBRID_HPP_
...
/**
 * @struct syncai_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for syncai_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class syncai_planner::NodeHybrid
...
public:
  ...
  /**
   * @class syncai_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for syncai_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for syncai_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const unsigned int index);

  /**
   * @brief A destructor for syncai_planner::NodeHybrid
   */
  ~NodeHybrid();
  ...
  static float getHeuristicCost(
    ...
    const syncai_costmap_2d::Costmap2D * costmap);
  ...
  static void resetObstacleHeuristic(
    syncai_costmap_2d::Costmap2D * costmap,
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, syncai_planner::NodeHybrid * &)> & validity_checker,
  ...
  static syncai_costmap_2d::Costmap2D * sampled_costmap;
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_HYBRID_HPP_
