...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__CONSTANTS_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__CONSTANTS_HPP_
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__CONSTANTS_HPP_
