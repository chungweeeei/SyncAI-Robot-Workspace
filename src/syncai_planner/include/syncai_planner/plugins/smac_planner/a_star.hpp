...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__A_STAR_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__A_STAR_HPP_
...
/**
 * @class syncai_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct syncai_planner::NodeComparator
  ...
  /**
   * @brief A constructor for syncai_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for syncai_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__A_STAR_HPP_
