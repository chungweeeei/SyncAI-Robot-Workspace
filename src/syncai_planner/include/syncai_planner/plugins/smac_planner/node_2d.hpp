...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_2D_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_2D_HPP_
...
public:
  ...
  /**
   * @class syncai_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for syncai_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const unsigned int index);

  /**
   * @brief A destructor for syncai_planner::Node2D
   */
  ~Node2D();
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, syncai_planner::Node2D * &)> & validity_checker,
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__NODE_2D_HPP_
