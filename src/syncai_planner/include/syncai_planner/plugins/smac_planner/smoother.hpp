...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__SMOOTHER_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class syncai_planner::PathSegment
...
/**
 * @struct syncai_planner::BoundaryPoints
...
/**
 * @struct syncai_planner::BoundaryExpansion
...
public:
  /**
   * @brief A constructor for syncai_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for syncai_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__SMOOTHER_HPP_
