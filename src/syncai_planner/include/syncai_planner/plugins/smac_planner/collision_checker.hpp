...
#ifndef SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace syncai_planner
{

/**
 * @class syncai_planner::GridCollisionChecker
 * @brief A costmap grid collision checker
 */
class GridCollisionChecker
  : public syncai_costmap_2d::FootprintCollisionChecker<syncai_costmap_2d::Costmap2D *>
{
public:
  /**
   * @brief A constructor for syncai_planner::GridCollisionChecker
   ...
   */
  void setFootprint(
    const syncai_costmap_2d::Footprint & footprint,
    const bool & radius,
...
protected:
  std::vector<syncai_costmap_2d::Footprint> oriented_footprints_;
  syncai_costmap_2d::Footprint unoriented_footprint_;
...
#endif  // SYNCAI_PLANNER__PLUGINS__SMAC_PLANNER__COLLISION_CHECKER_HPP_
