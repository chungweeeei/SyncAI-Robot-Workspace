...
#include "syncai_controller/plugins/pose_progress_checker.hpp"
#include <cmath>
#include <string>
#include <memory>
#include <vector>
...
PLUGINLIB_EXPORT_CLASS(syncai_controller::PoseProgressChecker, syncai_nav_core::ProgressChecker)
