...
#include <string>
#include <limits>
#include "syncai_controller/plugins/position_goal_checker.hpp"
...
void syncai_controller::PositionGoalChecker::setXYGoalTolerance(double tolerance)
{
...
PLUGINLIB_EXPORT_CLASS(syncai_controller::PositionGoalChecker, syncai_nav_core::GoalChecker)
