...
#ifndef SYNCAI_CONTROLLER__PLUGINS__SIMPLE_PROGRESS_CHECKER_HPP_
#define SYNCAI_CONTROLLER__PLUGINS__SIMPLE_PROGRESS_CHECKER_HPP_
...
class SimpleProgressChecker : public syncai_nav_core::ProgressChecker
{
public:
  void initialize(
...
#endif  // SYNCAI_CONTROLLER__PLUGINS__SIMPLE_PROGRESS_CHECKER_HPP_
