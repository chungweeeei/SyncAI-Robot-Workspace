...
PLUGINLIB_EXPORT_CLASS(syncai_costmap_2d::InflationLayer, syncai_costmap_2d::Layer)

using syncai_costmap_2d::LETHAL_OBSTACLE;
using syncai_costmap_2d::INSCRIBED_INFLATED_OBSTACLE;
...
void InflationLayer::onInitialize()
{
  ...
  if (!node_) {
    throw std::runtime_error{"Failed to get node in InflationLayer"};
  }
...
void InflationLayer::matchSize()
{
  ...
  syncai_costmap_2d::Costmap2D * costmap = layered_costmap_->getCostmap();
...
/**
 * @brief  Given an index of a cell in the costmap, place it into a list pending for obstacle
 * inflation
 */
