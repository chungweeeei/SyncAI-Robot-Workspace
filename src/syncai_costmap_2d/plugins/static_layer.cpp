#include "syncai_costmap_2d/static_layer.hpp"
...
PLUGINLIB_EXPORT_CLASS(syncai_costmap_2d::StaticLayer, syncai_costmap_2d::Layer)
...
{
  RCLCPP_DEBUG(logger_, "Processing new map");
...
{
  if (!syncai_util::validateMsg(*new_map)) {
...
{
  std::lock_guard<syncai_costmap_2d::Costmap2D::mutex_t> guard(*getMutex());
