#ifndef SYNCAI_COSTMAP_2D__LAYERED_COSTMAP_HPP_
#define SYNCAI_COSTMAP_2D__LAYERED_COSTMAP_HPP_
...
public:
  ...
  {
    return combined_costmap_.getDefaultValue() == syncai_costmap_2d::NO_INFORMATION;
  }
