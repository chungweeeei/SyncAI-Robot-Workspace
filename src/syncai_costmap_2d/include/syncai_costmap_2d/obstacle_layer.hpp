#ifndef SYNCAI_COSTMAP_2D__OBSTACLE_LAYER_HPP_
#define SYNCAI_COSTMAP_2D__OBSTACLE_LAYER_HPP_
...
#include "syncai_costmap_2d/observation_buffer.hpp"
...
public:
  ...
  void addStaticObservation(syncai_costmap_2d::Observation & obs, bool marking, bool clearing);
...
protected:
  ...
  bool getMarkingObservations(
    std::vector<syncai_costmap_2d::Observation> & marking_observations) const;
  ...
  bool getClearingObservations(
    std::vector<syncai_costmap_2d::Observation> & clearing_observations) const;
  ...
  virtual void raytraceFreespace(
    const syncai_costmap_2d::Observation & clearing_observation, double * min_x, double * min_y,
    double * max_x, double * max_y);
  ...
  std::vector<std::shared_ptr<syncai_costmap_2d::ObservationBuffer>> observation_buffers_;
  /// @brief Used to store observation buffers used for marking obstacles
  std::vector<std::shared_ptr<syncai_costmap_2d::ObservationBuffer>> marking_buffers_;
  /// @brief Used to store observation buffers used for clearing obstacles
  std::vector<std::shared_ptr<syncai_costmap_2d::ObservationBuffer>> clearing_buffers_;

  /// @brief Dynamic parameters handler
  rclcpp::node_interfaces::OnSetParametersCallbackHandle::SharedPtr dyn_params_handler_;

  // Used only for testing purposes
  std::vector<syncai_costmap_2d::Observation> static_clearing_observations_;
  std::vector<syncai_costmap_2d::Observation> static_marking_observations_;
...
#endif  // SYNCAI_COSTMAP_2D__OBSTACLE_LAYER_HPP_
